...
export class EncuestaService {
  ...
  anularEncuesta(data: Encuesta): any {
    return this.httpClient.post<any>(this.url + '/encuesta/encuesta/anularEncuesta?token=' + this.token, data);
  }
...
public  GetListEncuestas(todos: Number, fecha: Number, fechainicial: String, fechafinal: String): Observable<any> {
...
public  GetListEncuestasSubRed(todos: Number, fecha: Number, fechainicial: String, fechafinal: String, sub_id: number): Observable<any> {
